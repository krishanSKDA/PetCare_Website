<div>
        ...
        @foreach($pets as $pet)
            <div class="p-4 bg-white rounded-lg shadow">
                ...
                <div class="flex justify-between mt-4">
                    ...
                    <x-mary-button icon="o-trash" wire:click="confirmPetDeletion({{$pet->id}})" class="btn-danger">
                        Delete
                    </x-mary-button>

                </div>
                @if($confirmingPetDeletion)
                ...
                <x-mary-modal>
                    ...
                    <x-mary-button wire:click="deletePet" class="btn-danger">Yes, Delete</x-mary-button>
    ...
    <x-mary-modal wire:model="petModal" title="{{ $modelId ? 'Edit Pet' : 'Create Pet' }}" class="backdrop-blur">
        <x-mary-form wire:submit.prevent="savePet">
            ...
            <div class="flex justify-between mt-4">
                <x-mary-button type="submit" wire:click="savePet">
...
@if ($petModal)
<x-mary-modal wire:model="confirmingPetDeletion" title="Delete Pet" class="backdrop-blur">
...
@endif
        <x-mary-button wire:click="deletePet" class="btn-danger">
            Yes, Delete
        </x-mary-button>
        <x-mary-button wire:click="$set('confirmingPetDeletion', false)" class="btn-secondary">
            Cancel
        </x-mary-button>
    </div>
@endif
